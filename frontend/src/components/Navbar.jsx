           ...
           <p className="font-sans text-blue-500  text-3xl font-extrabold">
            ...
            <div>
               <nav className="flex gap-4 ">
                    ...
                    {loggedIn ? <Link to="/user" className="font-sans text-blue-500 sm:text-2xl lg:text-xl">User</Link>: <Link to="/login" className="font-sans text-blue-500 sm:text-2xl lg:text-xl">Login</Link> }
               </nav> 
            </div>
        </div>
    );
